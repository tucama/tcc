...
# fd "^.{4}\.pdb" -t f  -a -x cp automatize.tcl {//}/{/.}_auto.tcl && fd "^.{4}\.pdb" -t f -a -x sd "/home/tucamar/Documents/tcc/tcc-arthur/00_dataset/1a4y/1a4y_wt_A_B_final.pdb" {} {//}/{/.}_auto.tcl

# Get the input file path
set input_file "/home/tucamar/Documents/tcc/tcc-arthur/00_dataset/1a4y/1a4y_wt_A_B_final.pdb"
