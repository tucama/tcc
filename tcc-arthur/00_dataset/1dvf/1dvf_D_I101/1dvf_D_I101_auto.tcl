...
# fd "^.{4}\.pdb" -t f  -a -x cp automatize.tcl {//}/{/.}_auto.tcl && fd "^.{4}\.pdb" -t f -a -x sd "/home/tucamar/Documents/tcc/tcc-arthur/00_dataset/1dvf/1dvf_D_I101_AB_CD_final.pdb" {} {//}/{/.}_auto.tcl

# Get the input file path
set input_file "/home/tucamar/Documents/tcc/tcc-arthur/00_dataset/1dvf/1dvf_D_I101_AB_CD_final.pdb"
